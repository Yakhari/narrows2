...
<?php
    ...
    $q = "SELECT date, posted_by, content FROM adminama ORDER BY post_id DESC"; 
...
if(isset($_POST['Reply'])) {	
    $reply = $_POST["message"] ?? "";
    $sql = $conn->query("INSERT INTO adminama(posted_by, content) VALUES('$username','$reply')");
    header("Location: adminama.php");
}
?>
</table>
